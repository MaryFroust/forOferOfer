...
//*`addAll` - given an array of numbers, returns the sum of all numbers added together.
 //**HINT:** this is a reduce problem, reducing a collection of values to one value. In this case, a collection of numbers to one total sum.
...
//  **HINT:** this is a reduce problem, reducing a collection of values to one value. counter ++
...
//*`makeFriendly` - given a paragraph, returns a paragraph where each sentence ends with an exclamation 
